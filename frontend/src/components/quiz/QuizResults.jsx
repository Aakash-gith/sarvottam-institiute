            ...
            <div className="bg-bg-2 rounded-2xl p-8 shadow-xl mb-6">
              ...
              <div className="border-t border-gray-700 pt-6">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-red-600 hover:from-blue-700 hover:to-red-700 disabled:from-gray-600 disabled:to-gray-600 disabled:cursor-not-allowed text-white font-semibold py-3 px-6 rounded-xl transition-all"
                >
